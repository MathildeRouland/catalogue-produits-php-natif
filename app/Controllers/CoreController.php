...
/**
    ...
    {
        // Mettre en place les ACL (regrouper les droits d'accès aux pages)
        // = attribuer les rôles qui auront accès aux différentes pages
        // user-list -> admin
        // category-list -> admin, catalog-manager

        // Liste des rôles autorisés par route
        // $acl = [
        ...
        //     'product-edit-post' => ['admin', 'catalog-manager'],
        //     'user-list' => ['admin'],
        //     'user-add' => ['admin'],
        //     'user-add-post' => ['admin'],
        //     'category-select-post' => ['admin', 'catalog-manager'],
     ...
     * @return void
     */
    // Méthode créée dans le CoreController pour qu'elle soit accessible dans tous les contrôleurs
