...
/**
     * Récupérer les 5 derniers produits créés
     *
     * @return Product[]
     */
    ...
    public function update()
    {
        ...
        $sql = "UPDATE product SET name = :name, `description` = :description, picture = :picture, price = :price, rate = :rate,status = :status , brand_id= :brand_id,category_id= :category_id, type_id = :type_id WHERE id = :id";
